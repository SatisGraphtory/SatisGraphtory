...
export default function GraphApp(props) {
  ...
  React.useEffect(() => {
    ...
    if (urlParams.get('useBlank')) {
      ...
      data = {
        d:
          '',
        c: 0,
        v: '0.1.0',
        h: -1677618805,
      };
