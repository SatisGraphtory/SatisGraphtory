...
export default function GraphApp(props) {
  ...
  React.useEffect(() => {
    ...
    if (urlParams.get('useBlank')) {
      ...
      data = {
        d:
          'CgBgCGAACIADAUlIBgBAkDgAOAUgcgD0BpgMWQFgAigaoDLIACEgK4AtUAggJQAEAJAMAAEgJKQAN5AAGqKQEAscgIoAkgPIAYgLGQAMgEPYkMAAgABQCQAcgCIAoydQAwABOoAB+Ug3YAJkgArpAAPXIAm3wAoADlJpBAA=',
        c: 0,
        v: '0.1.0',
        h: -1677770246,
      };
